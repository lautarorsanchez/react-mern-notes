      ...
      <section className="md:flex justify-between items-center py-4">
        <span>
          ...
          <p className="mb-5 text-sm">
            Share something nice :) It will be posted in our board. <br></br>{" "}
            Please don't be offensive, it's a professional portfolio app.{" "}
          </p>
        </span>
      ...
      >
        {({ handleSubmit, setFieldValue, isSubmitting }) => (
          <Form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="rounded w-full px-2 py-2 bg-indigo-700  hover:bg-indigo-900 text-white "
